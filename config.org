...
#+end_src
**** Agenda
Add notes with =todo= keyword to agenda.
#+begin_src emacs-lisp :tangle config.el
(defun my/denote-refresh-agenda-files ()
  "Refresh agenda files using a regex for todo and project tags"
  (interactive)
  (setq org-agenda-files
        (denote-directory-files "_\\(todo\\|project\\)")))

(add-hook 'org-agenda-prepare-finalize-hook #'my/denote-add-to-agenda-files)
#+end_src
* Pulsar :enabled:
